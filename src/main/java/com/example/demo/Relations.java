...
public class Relations {
    ...
    public void enregistreMotEleve(Connection conn, int _idMot, int _idEleve) throws SQLException {
        String SQL = "INSERT INTO MotEleve(idMot, idEleve) VALUES (?,?)";
        try(PreparedStatement pstmt = conn.prepareStatement(SQL))
        {
            pstmt.setInt(1, _idMot);
            pstmt.setInt(2, _idEleve);
    ...
    public void enregistreMotParent(Connection conn, int _idMot, int _idParent) throws SQLException {
        String SQL = "INSERT INTO MotParent(idMot, idParent) VALUES (?,?)";
        try(PreparedStatement pstmt = conn.prepareStatement(SQL))
        {
            pstmt.setInt(1, _idMot);
            pstmt.setInt(2, _idParent);
    ...
    public void enregistreParentEleve(Connection conn, int _idParent, int _idEleve) throws SQLException {
        String SQL = "INSERT INTO ParentEleve(idParent, idEleve) VALUES (?,?)";
        try(PreparedStatement pstmt = conn.prepareStatement(SQL))
        {
            pstmt.setInt(1, _idParent);
            pstmt.setInt(2, _idEleve);
    ...
    public void enregistreClasseEleve(Connection conn, int _idClasse, int _idEleve) throws SQLException {
    ...
    public void enregistreClasseEnseignant(Connection conn, int _idClasse, int _idEnseignant) throws SQLException {
        String SQL = "INSERT INTO ClasseEnseignant(idClasse, idEnseignant) VALUES (?,?)";
        try(PreparedStatement pstmt = conn.prepareStatement(SQL))
        {
            pstmt.setInt(1, _idClasse);
            pstmt.setInt(2, _idEnseignant);
    ...
    /*MotEleve (id, idMot, idEleve);*/
    public void deleteMotEleve(Connection conn, int _idMot, int _idEleve) throws SQLException {
        try {
    ...
    /*MotParent (id, idMot, idParent);*/
    public void deleteMotParent(Connection conn, int _idMot, int _idParent) throws SQLException {
        try {
    ...
    /*ParentEleve (id, idParent, idEleve);*/
    public void deleteParentEleve(Connection conn, int _idParent, int _idEleve) throws SQLException {
        try {
    ...
    /*ClasseEleve (id, idClasse, idEleve);*/
    public void deleteClasseEleve(Connection conn, int _idClasse, int _idEleve) throws SQLException {
        try {
    ...
    /*ClasseEnseignant (id,idClasse, idEnseignant);*/
    public void deleteClasseEnseignant(Connection conn, int _idClasse, int _idEnseignant) throws SQLException {
        try {
    ...
    // UPODATE
    /*MotEleve (id, idMot, idEleve);*/
    public void updateMotEleve(Connection conn, int _idMot, int _idEleve, int _newIdMot, int _newIdEleve) throws SQLException {
        try {
    ...
    /*MotParent (id, idMot, idParent);*/
    public void updateMotParent(Connection conn, int _idMot, int _idParent, int _newIdMot, int _newIdParent) throws SQLException {
        try {
    ...
    /*ParentEleve (id, idParent, idEleve);*/
    public void updateParentEleve(Connection conn, int _idParent, int _idEleve, int _newIdParent, int _newIdEleve) throws SQLException {
        try {
    ...
    /*ClasseEleve (id, idClasse, idEleve);*/
    public void updateClasseEleve(Connection conn, int _idClasse, int _idEleve, int _newIdClasse, int _newIdEleve) throws SQLException {
        try {
    ...
    /*ClasseEnseignant (id,idClasse, idEnseignant);*/
    public void updateClasseEnseignant(Connection conn, int _idClasse, int _idEnseignant, int _newIdClasse, int _newIdEnseignant) throws SQLException {
        try {
